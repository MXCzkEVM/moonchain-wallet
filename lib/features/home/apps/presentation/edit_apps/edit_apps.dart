...
import 'edit_apps_presenter.dart';
import 'edit_apps_state.dart';

class EditApps extends HookConsumerWidget {
  const EditApps({Key? key}) : super(key: key);

  @override
  ProviderBase<EditAppsPresenter> get presenter =>
      editAppsPageContainerv.actions;

  @override
  ProviderBase<EditAppsPageState> get state => editAppsPageContainerv.state;
