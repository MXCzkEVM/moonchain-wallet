...
class LocalAuthentication {
  ...
  // iOS only
  Future<BiometricType?> getIosBiometricType() async {
    final result =
        await _channel.invokeMapMethod('getSystemBiometricsWithError') ?? {};
    final biometricType = result['biometryType'];

    if (biometricType == 'LABiometryTypeFaceID') {
      return BiometricType.face;
    } else if (biometricType == 'LABiometryTypeTouchID') {
  ...
  // Android only
  Future<bool> userHasActiveFingerprints() async =>
